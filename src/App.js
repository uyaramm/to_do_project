  ...
  //add task
   ...
   function searchTask(){
    if (searchDescription!== ""){
      ...
      task.taskDescription.toLowerCase().includes(searchDescription.toLowerCase())
    );
...
>
 ...
 >
      ...
      label="Search..." 
      sx={{ flex: '1 1 200px'}} //ajustar com a tela
      />
    ...
    <p style={{ color: '#1976D2', fontSize:'17px'}}>Check if task is completed</p>

      {checkMessage && <Alert severity="success">Well done! Task completed </Alert>}
        ...
        '&:hover': {
          ...
          '&:hover': {
            backgroundColor: '#e4f1fe'
              ...
              <ListItemText id={labelId} primary={`${value.taskDescription}`} />
            </ListItemButton>
          </ListItem>
    ...
    >
      ...
      variant="contained" 
      size='small' 
      sx={{ padding: '8px 16px', fontSize: '0.7rem',fontWeight:'bold',border:'1px solid #E4F1FE',backgroundColor:'#E4F1FE', color:'#1976D2',
      '&:hover': { 
      color: '#E4F1FE', 
      backgroundColor: '#1976D2',
      },
